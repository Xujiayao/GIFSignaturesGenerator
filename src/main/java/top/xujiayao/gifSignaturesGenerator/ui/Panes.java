...
public class Panes {
	...
	public Pane pane3() {
		...
		text000.setFont(new Font("Microsoft YaHei", 14));
		...
		button3.setFont(new Font("Microsoft YaHei", 12));
		...
		text0000.setFont(new Font("Microsoft YaHei", 14));
		...
		button4.setFont(new Font("Microsoft YaHei", 12));
